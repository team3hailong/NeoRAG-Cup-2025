...
vector_db = VectorDatabase(db_type= "mongodb") # baseline model: "mongodb", vector search
...
# - Sentence Transformers: model_name="all-MiniLM-L6-v2", type="sentence_transformers"
...
from metrics_rag import calculate_metrics_retrieval, calculate_metrics_llm_answer, hit_k
...
print("Recall@7:", hit_k("CLB_PROPTIT.csv", "train_data_proptit.xlsx", embedding, vector_db, k=7))