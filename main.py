...
# - Sentence Transformers: model_name="VoVanPhuc/sup-SimCSE-VietNamese-phobert-base", type="sentence_transformers"
embedding = Embeddings(model_name="VoVanPhuc/sup-SimCSE-VietNamese-phobert-base", type="sentence_transformers")
...
from metrics_rag import calculate_metrics_retrieval, calculate_metrics_llm_answer, hit_k, recall_k
...
print("Recall@7:", recall_k("CLB_PROPTIT.csv", "train_data_proptit.xlsx", embedding, vector_db, k=7))