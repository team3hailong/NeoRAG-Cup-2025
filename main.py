...
from metrics_rag import calculate_metrics_retrieval, calculate_metrics_llm_answer, hit_k, recall_k, precision_k, context_precision_k
...
print("Context_precision@5:", context_precision_k("CLB_PROPTIT.csv", "train_data_proptit.xlsx", embedding, vector_db, k=5))