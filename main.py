...
from metrics_rag import  ndcg_k, groundedness_k, hit_k, bleu_4_k, context_recall_k, rouge_l_k, string_presence_k, context_entities_recall_k, context_precision_k, noise_sensitivity_k, calculate_metrics_retrieval, calculate_metrics_llm_answer, recall_k
...
print("noise_sensitivity_k@3:", noise_sensitivity_k("CLB_PROPTIT.csv", "test_data_proptit.xlsx", embedding, vector_db, k=3, reranker=reranker, use_query_expansion=use_query_expansion))