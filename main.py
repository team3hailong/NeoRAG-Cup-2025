...
vector_db = VectorDatabase(db_type= FIX_ME) # baseline model: "mongodb"

# Sửa chỗ FIX_ME để dùng embedding model mà các em muốn, hoặc các em có tự thêm embedding model trong lớp Embeddings

embedding = Embeddings(model_name= FIX_ME, type= FIX_ME) # baseline model: "text-embedding-3-large", "openai"
